...
data_clean=pd.read_csv(r'C:\Users\rana_\OneDrive\Bureau\Project_5\data_clean.csv')
...
st.text("")
st.text("") 
st.write("We analyzed correlation between numeric variables of our dataset and found that there is no high correlation between variables.")
st.text("") 
